...
-- \x.S (K (x true)) I
-- S (\x.S (K (x true))) (K I)
-- S (S (K S) (\x.K (x true))) (K I)
-- S (S (K S) (S (K K) (S I (K true)))) (K I)
or' = Ap (Ap S (Ap (Ap S (Ap K S)) (Ap (Ap S (Ap K K)) (Ap (Ap S I) (Ap K true))))) (Ap K I)

-- \x.\y.x (y false true) (y true false)
-- \x.S (\y.x (y false true)) (\y.y true false)
-- \x.S (S (K x) (\y.y false true)) (S (\y.y true) (K false))
-- \x.S (S (K x) (S (S I (K false)) (K true))) (S (S I (K true)) (K false))
-- S (\x.S (S (K x) (S (S I (K false)) (K true)))) (\x.S (S I (K true)) (K false))
-- S (S (K S) (\x.S (K x) (S (S I (K false)) (K true)))) (S (\x.S (S I (K true))) (K (K false)))
-- S (S (K S) (S (\x.S (K x)) (K (S (S I (K false)) (K true))))) (S (S (K S) (K (S I (K true)))) (K (K false)))
-- S (S (K S) (S (S (K S) K) (K (S (S I (K false)) (K true))))) (S (S (K S) (K (S I (K true)))) (K (K false)))
